...
CREATE TABLE IF NOT EXISTS social_media_kpis (
    ...
    instagram_stories_quality INTEGER CHECK (instagram_stories_quality >= 0 AND instagram_stories_quality <= 10),
    instagram_posts INTEGER DEFAULT 0,
    instagram_posts_quality INTEGER CHECK (instagram_posts_quality >= 0 AND instagram_posts_quality <= 10),
    instagram_reels INTEGER DEFAULT 0,
    instagram_reels_quality INTEGER CHECK (instagram_reels_quality >= 0 AND instagram_reels_quality <= 10),
    facebook_stories INTEGER DEFAULT 0,
    facebook_stories_quality INTEGER CHECK (facebook_stories_quality >= 0 AND facebook_stories_quality <= 10),
    facebook_posts INTEGER DEFAULT 0,
    facebook_posts_quality INTEGER CHECK (facebook_posts_quality >= 0 AND facebook_posts_quality <= 10),
    facebook_reels INTEGER DEFAULT 0,
    facebook_reels_quality INTEGER CHECK (facebook_reels_quality >= 0 AND facebook_reels_quality <= 10),
    tiktok_stories INTEGER DEFAULT 0,
    tiktok_stories_quality INTEGER CHECK (tiktok_stories_quality >= 0 AND tiktok_stories_quality <= 10),
    tiktok_posts INTEGER DEFAULT 0,
    tiktok_posts_quality INTEGER CHECK (tiktok_posts_quality >= 0 AND tiktok_posts_quality <= 10),
    tiktok_reels INTEGER DEFAULT 0,
    tiktok_reels_quality INTEGER CHECK (tiktok_reels_quality >= 0 AND tiktok_reels_quality <= 10),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS website_seo_kpis (
    ...
    keyword_names TEXT[] DEFAULT '{}',
    keyword_positions INTEGER[] DEFAULT '{}',
